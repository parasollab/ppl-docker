...
# ^^ IF getting some sort of qt build error with cmake_pch.hxx.gch , run with jobs=2 or =1. 
...
cmake --build build -- -j 4 # if getting some sort of error / build not finishing, use -j2 or -j1. 
